...
- **Деплой-аномалия ЗАКРЫТА:** push 036c9a2 не породил run (разовая потеря события GitHub); контрольный push S074-docs run породил (31129948595) — триггер жив. Привычка остаётся: после push в master проверять появление run'а
