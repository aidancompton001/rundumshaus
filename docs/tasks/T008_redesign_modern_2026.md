...
## Решения, которые нужны от CEO (бинарные)

| # | Вопрос | Вариант A | Вариант B | Рекомендация |
|---|--------|-----------|-----------|--------------|
| 1 | Preview-механизм для Kevin | Отдельный GH-репо + Pages (бесплатно, наш стек) | Vercel preview (быстрее, новый сервис) | **A** |
| 2 | Фото услуг | Ждём фото Kevin | Placeholder из текущих + AI-генерация | **B** (не блокировать редизайн) |
| 3 | Titles услуг как в референсе («Hausmeisterservice & Gebäudereinigung») | Меняем title, URL те же | Оставляем текущие | **A** (URL не трогаются, SEO-риска нет) |
