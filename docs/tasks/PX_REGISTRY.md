...
<!-- Последний номер: PX-076 -->

## PX-075
**Дата:** 2026-06-11
**Статус:** завершено (отчёт принят)
**DEVLOG:** S070
**Источник:** Kevin WhatsApp 2026-06-11 (замер позиций: Hausmeisterservice Osnabrück #5, Gartenpflege Osnabrück #13)
**Задача:** SEO-исследование: путь в топ-3 по «Hausmeisterservice Osnabrück» (#5) и реалистичная цель по «Gartenpflege Osnabrück» (#13)
**Контекст:** rundumshaus-littawe.de — главная, /leistungen/hausmeisterservice/osnabrueck/, /leistungen/gartenpflege/osnabrueck/, /osnabrueck/ hub, GBP Kevin (9 отзывов 5 Sterne)
**Цель:** Отчёт: кто выше и почему (контент, ссылки, GBP, возраст домена), 3-5 приоритетных действий с разбивкой «мы / Kevin» и ожидаемым эффектом
**Ограничения:** Только исследование, никаких правок кода/контента; позиции — замер Кевина, перепроверить нейтрально; не выдумывать данные конкурентов
**Размер:** M | **Промпт:** P10
---
...
**Статус:** завершено (отчёт принят)
**DEVLOG:** S071
**Источник:** Kevin WhatsApp 2026-06-11 23:16 («Kann man irgendwo sehen was für Gartenarbeit in Osnabrück gesucht wird?»)
**Задача:** Keyword-исследование: реальный спрос по Gartenarbeit-запросам в Osnabrück (rasen mähen / unkraut entfernen / hecke schneiden и т.п.)
**Контекст:** GSC rundumshaus-littawe.de (реальные запросы/показы), Google Suggest/autocomplete, данные PX-075 (H2-структура конкурентов)
**Цель:** Таблица: запрос → подтверждённый сигнал спроса → наша видимость (GSC) → рекомендация (таргет/контент/игнор) + ответ Кевину
**Ограничения:** Только исследование; объёмы не выдумывать — только GSC-показы и autocomplete; без Keyword Planner точных цифр нет (честно пометить)
**Размер:** M | **Промпт:** P10
---
