// PX-069: Entrümpelung city template — ALL visible texts from src/data/templates/entruempelung.json
...
import templateTexts from "@/data/templates/entruempelung.json";
