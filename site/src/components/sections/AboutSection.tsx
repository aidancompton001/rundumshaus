      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <ScrollReveal direction="right">
            {/* PX-068: image path + alt now read from homepage.json (CMS-editable).
                Responsive variants are auto-generated by the prebuild step
                (scripts/admin/generate-image-variants.mjs) — Design Review E3. */}
